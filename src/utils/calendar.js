...
export let calendar = {
   ...
   * @return day Number
   * @eg:let _24 = calendar.getTerm(1987,3) //_24=4意即1987年2月4日立春
   */
  ...
  solar2lunar: function (y, m, d) { // 参数区间1900.1.31~2100.12.31
    ...
    return {
      date: solarDate,
      lunarDate: lunarDate,
      festival: festival[festivalDate] ? festival[festivalDate].title : null, // 阳历与阴历的节日
      ...
      'IDayCn': this.toChinaDay(day), // 阴历的日期
      'cYear': y,
      'cMonth': m,
      'cDay': d,
      'gzYear': gzY,
